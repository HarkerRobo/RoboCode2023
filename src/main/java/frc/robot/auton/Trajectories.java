...
public final class Trajectories {
    public static TrajectoryConfig defaultConfig = new TrajectoryConfig(RobotMap.MAX_DRIVING_SPEED,
            RobotMap.MAX_DRIVING_SPEED / 2).setKinematics(Drivetrain.getInstance().getKinematics());
