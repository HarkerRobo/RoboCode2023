...
public class SwervePositionController extends CommandBase {
  ...
  public SwervePositionController(Trajectory trajectory,BiFunction<Pose2d, Double, Rotation2d> refHeading,Supplier<Rotation2d> startHeading) {
  ...
  public SwervePositionController(Trajectory trajectory, BiFunction<Pose2d, Double, Rotation2d> refHeading) {
  ...
  public void execute() {
    ...
    // Return next output.
    ChassisSpeeds adjustedSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(xFF + xFeedback, yFF + yFeedback, thetaFF, currentPose.getRotation());
