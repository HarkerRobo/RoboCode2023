...
public final class CameraPoseEstimation {
  ...
  public static final List<AprilTag> aprilTags =
    ...
    public CameraPoseEstimation() {
      aprilTagFieldLayout = new AprilTagFieldLayout(CameraPoseEstimation.aprilTags, 16.4846,
  8.1026);
      cam = new PhotonCamera("limelight");
      robotToCam = new Transform3d(new Translation3d(0, Units.inchesToMeters(10.81259), 0), new Rotation3d(0, 0, 0));
